	...
	<div class="page">
		<div class="search-container">
			...
			<section class="search-result-wrap" v-if="!isShowHistory">
				<cFilterBar v-if="searchResult.length" @filter="filterSearchData" :hasHeader="false"></cFilterBar>
				<section v-if="isShowEmpty" class="empty-icon empty-icon-goods">
					<span>抱歉，没有找到相关商品</span>
				</section>
				<div class="result-list search-result" :class="{ grid: isGridLayout }" v-loadmore="loadMore" is-enable-scroll="isLoading"  v-else-if="searchResult.length">
